...
public class MuSigCreateOfferAmountView extends View<VBox, MuSigCreateOfferAmountModel, MuSigCreateOfferAmountController> {
    ...
    public MuSigCreateOfferAmountView(MuSigCreateOfferAmountModel model,
        ...
        fixedAmount = new Button(Res.get("muSig.tradeWizard.amount.amountModel.fixedAmount"));
        fixedAmount.getStyleClass().add("model-selection-item");
        rangeAmount = new Button(Res.get("muSig.tradeWizard.amount.amountModel.rangeAmount"));
        ...
        closeOverlayButton = new Button(Res.get("muSig.tradeWizard.amount.limitInfo.overlay.close"));
        learnHowToBuildReputation = new Button(Res.get("muSig.tradeWizard.amount.limitInfo.overlay.learnHowToBuildReputation"));
        ...
        overlay = new WizardOverlay(root)
                .warning()
                .headline("muSig.tradeWizard.amount.limitInfo.overlay.headline")
