...
public class MuSigTradeLimitsSimulationController implements Controller {
    ...
    public MuSigTradeLimitsSimulationController(ServiceProvider serviceProvider) {
        MuSigTradeLimitsSimulationModel model = new MuSigTradeLimitsSimulationModel();
        MuSigTradeLimitsSimulation preview = new MuSigTradeLimitsSimulation();
        view = new MuSigTradeLimitsSimulationView(model, this, preview.getViewRoot());
    }
