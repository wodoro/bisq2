...
public class MuSigCreateOfferView extends NavigationView<VBox, MuSigCreateOfferModel, MuSigCreateOfferController> {
    ...
    private String getLabelForTarget(NavigationTarget target) {
        return switch (target) {
            case MU_SIG_CREATE_OFFER_DIRECTION_AND_MARKET -> Res.get("muSig.tradeWizard.progress.directionAndMarket");
            case MU_SIG_CREATE_OFFER_AMOUNT_AND_PRICE -> Res.get("muSig.tradeWizard.progress.amountAndPrice.createOffer");
            case MU_SIG_CREATE_OFFER_PAYMENT_METHODS -> model.getPaymentMethodProgressLabel();
            case MU_SIG_CREATE_OFFER_REVIEW_OFFER -> Res.get("muSig.tradeWizard.progress.review");
            default -> "";
        };
    }
