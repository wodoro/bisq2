...
package bisq.desktop.main.content.mu_sig.trade.open_trades.trade_state;
...
public class MuSigTradeDataHeader {
        ...
        public void onActivate() {
            channelPin = EasyBind.subscribe(model.getChannel(), channel -> {
                ...
                if (trade.isSellerInDisplayContext()) {
                    ...
                    model.getLeftAmountDescription().set(Res.get("muSig.trade.pending.header.send").toUpperCase());
                    model.getLeftAmount().set(baseAmountString);
                    model.getLeftCode().set(baseAmount.getCode());
                    model.getRightAmountDescription().set(Res.get("muSig.trade.pending.header.receive").toUpperCase());
                    ...
                    model.getLeftAmountDescription().set(Res.get("muSig.trade.pending.header.pay").toUpperCase());
    ...
    private static class View extends bisq.desktop.common.view.View<HBox, Model, Controller> {
        ...
        private View(Model model, Controller controller) {
            ...
            tradeId = getElements(Res.get("muSig.trade.pending.header.tradeId"));
