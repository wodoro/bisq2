...
public class MuSigTakeOfferPaymentView extends View<StackPane, MuSigTakeOfferPaymentModel, MuSigTakeOfferPaymentController> {
    ...
    public MuSigTakeOfferPaymentView(MuSigTakeOfferPaymentModel model,
        ...
        createAccountButton = new Button(Res.get("muSig.offer.take.paymentMethod.noAccountOverlay.createAccount"));
        createAccountButton.setDefaultButton(true);
        noAccountOverlay = new WizardOverlay(root)
                .warning()
                .descriptionFromI18nKey("muSig.offer.take.paymentMethod.noAccountOverlay.subTitle")
        ...
        noPaymentMethodSelectedOverlay = new WizardOverlay(root)
                .warning()
                .headline("muSig.offer.take.paymentMethods.noPaymentMethodSelectedWizardOverlay.title")
                .descriptionFromI18nKey("muSig.offer.take.paymentMethods.noPaymentMethodSelectedWizardOverlay.subtitle")
    ...
    private VBox createAndGetContentBox() {
        Label subtitleLabel = new Label(Res.get("muSig.offer.take.paymentMethod.multipleAccountOverlay.subTitle"));
